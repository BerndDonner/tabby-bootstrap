#!/usr/bin/env python3
# ==========================================================
# 🗄️  Tabby DB Restore ← Hetzner Object Storage (S3)
# ==========================================================
...
def main():
    parser = argparse.ArgumentParser(description="Restore Tabby DB data ← Hetzner S3")
    ...
    log(f"🎉 Restore complete at {os.path.join(dest, 'ee')}")
